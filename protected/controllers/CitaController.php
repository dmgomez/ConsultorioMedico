	...
	public function accessRules()
	{
		return array(
			array('allow',  //Permite a los usuarios Administrador y Doctor Avanzado acceder a las acciones del Controlador
				'actions'=>array('index','view','create','update','delete','admin','BuscarPacientePorCedula', 'BuscarPacientePorID'),
	...
	*/
	public function actionBuscarPacientePorCedula(){
		...
		if($model){
			...
			$result = array('success' => true, 'cedula' => $model->cedula_paciente, 'paciente' => $model->nombre_paciente.' '.$model->apellido_paciente, 'id' => $model->paciente_id);
		}		
