...
class PatologiaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Patologia'];
			if($model->save()){

				Yii::app()->user->setFlash('success', 'Registro creado satisfactoriamente.');
				$this->redirect(array('view','id'=>$model->patologia_id));
			}
	...
	{
		$model=new Patologia('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Patologia']))
			$model->attributes=$_GET['Patologia'];
	...
	{
		$model=Patologia::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='patologia-form')
		{
