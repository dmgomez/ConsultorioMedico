	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Presentacion']))
		{
			...
			if($model->save()){
				...
				$this->redirect(array('view','id'=>$model->presentacion_id));
			}
	...
	public function actionDelete($id)
	{
		if(Yii::app()->request->isPostRequest)
		{
			...
			try {
				...
				Yii::app()->user->setFlash('error', 'Error. No se puede eliminar ya que tiene registros asociados. Consulte a su administrador de sistemas.');
			}
