...
class EstadoCivil extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('descripcion_estado_civil', 'required'),
			array('descripcion_estado_civil', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('estado_civil_id, descripcion_estado_civil', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'pacientes' => array(self::HAS_MANY, 'Paciente', 'estado_civil_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('descripcion_estado_civil',$this->descripcion_estado_civil,true);
